 ...
 * Copyright (c) 2019
 *
 * Don't use this file for synchronization, it has bugs!
 * This script create one large sql file for import, instead of multiple single sql files for each INSERT INTO clause.
 */
